...
public class TemplateTextDialog extends TitleAreaDialog {
	...
	public TemplateTextDialog(Shell parentShell, String title, String message, String[] fieldsName ) {
		this(parentShell, title, message, fieldsName, null, null);
	}
	public TemplateTextDialog(Shell parentShell, String title, String message, String[] fieldsName, String[] defaults ) {
		this(parentShell, title, message, fieldsName, defaults, null);
	}
	public TemplateTextDialog(Shell parentShell, String title, String message, String[] fieldsName, String[] defaults, String[][] invalid ) {
		super(parentShell);
		this.title = title;
