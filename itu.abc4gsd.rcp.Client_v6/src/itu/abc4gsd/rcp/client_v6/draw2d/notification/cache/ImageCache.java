package itu.abc4gsd.rcp.client_v6.draw2d.notification.cache;
...
//    	getImageDescriptor( IImageKeys.DELETE_2 ).createImage();
        ...
        if (is == null) {
            ...
            if (is == null) {
                ...
                if (is == null) {
                    is = classLoader.getResourceAsStream(fileName.substring(1));
//                    if (is == null) 
//                    	is = getImageDescriptor( fileName ).createImage();
