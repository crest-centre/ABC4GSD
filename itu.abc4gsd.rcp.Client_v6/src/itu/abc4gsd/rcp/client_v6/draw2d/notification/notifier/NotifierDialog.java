...
// Usage >> NotifierDialog.notify("TITLE", "BODY", NotificationType.values()[toUse]);


import itu.abc4gsd.rcp.client_v6.draw2d.notification.cache.ColorCache;
import itu.abc4gsd.rcp.client_v6.draw2d.notification.cache.FontCache;
...
public class NotifierDialog {
    ...
    public static void notify(String title, String message, NotificationType type) {
    	notify( title, message, type, ColorCache.getColor(177, 211, 243));
    }
    public static void notify(String title, String message, NotificationType type, final Color color ) {
...
//                    gc.setBackground(_bgBgGradient);
        ...
        int startY = clientArea.y + clientArea.height - 100;
