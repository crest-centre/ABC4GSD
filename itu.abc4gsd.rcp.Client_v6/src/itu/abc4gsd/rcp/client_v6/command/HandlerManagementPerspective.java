...
public class HandlerManagementPerspective implements IHandler {

	public Object execute(ExecutionEvent event) throws ExecutionException {
		BundleContext ctx = FrameworkUtil.getBundle(HandlerManagementPerspective.class).getBundleContext();
        ServiceReference<EventAdmin> ref = ctx.getServiceReference(EventAdmin.class);
        EventAdmin eventAdmin = ctx.getService(ref);
        Map<String,Object> properties = new HashMap<String, Object>();
        properties.put("PERP_ID", PerspectiveManagement.ID);
